...
(function (DateTimes) {
    var Dates = (function () {
        ...
        Dates.createFromService = function (value) {
            ...
            var time = Timestamp.createFromService(value);
            return new Date(time);
        };
        Dates.toMsJson = function (date) {
            return Dates.toServiceTimestamp(date);
        };
        Dates.toServiceTimestamp = function (date, includeOffset) {
    ...
    var Timestamp = (function () {
        ...
        Timestamp.createFromService = function (dateString, ignoreTimezoneAssumeUtc) {
        ...
        Timestamp.toServiceTimestamp = function (timestamp, isUtc, includeOffset) {
            if (isUtc === void 0) { isUtc = true; }
            if (includeOffset === void 0) { includeOffset = true; }
            return Dates.toServiceTimestamp(Timestamp.toDate(timestamp, isUtc), includeOffset);
        };
        Timestamp.toUtcServiceTimestamp = function (timestamp) {
            return Dates.toServiceTimestamp(new Date(timestamp + Timestamp.currentTimezoneOffsetMs));
        };
